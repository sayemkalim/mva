  ...
  useEffect(() => {
    if (correspondenceData) {
      ...
      if (correspondenceData.file_url) {
        const fullUrl = correspondenceData.file_url.startsWith("http")
          ? correspondenceData.file_url
          : `${import.meta.env.VITE_API_URL || "https://mva-backend.vsrlaw.ca/"}${correspondenceData.file_url}`;
