...
import { fetchTpCounselBySlug } from "../helpers/fetchTpCounselBySlug";
import { createTpCounsel } from "../helpers/createTpCounsel";
...
export default function TpCounselForm() {
  ...
  const { data: counselData, isLoading: loadingCounsel } = useQuery({
    queryKey: ["tpCounsel", slug],
    queryFn: () => fetchTpCounselBySlug(slug),
    enabled: !!slug,
  });
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        >
          {/* Firm Name */}
          <FloatingInput label="Firm Name" name="firm_name" value={formData.firm_name} onChange={handleInputChange} />
