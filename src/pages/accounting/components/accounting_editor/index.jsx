...
export default function AccountingPage() {
  ...
  const mutation = useMutation({
    mutationFn: (data) => {
      ...
      if (id) {
        return updateAccounting(id, data);
      } else {
        if (!slug) {
        ...
        return createAccounting({ slug, ...data });
      }
    },
    onSuccess: () => {
      toast.success(
        id
          ? "Accounting updated successfully!"
          : "Accounting saved successfully!"
      );
    ...
    onError: (err) => {
      ...
      toast.error(
        err.message ||
          (id ? "Failed to update Accounting" : "Failed to save Accounting")
      );
    },
  });
