...
import { exportLatFiles } from "@/utils/exportReportHelpers";

const ExportLatFiles = () => {
  ...
  const handleExport = async (e) => {
    ...
    try {
      ...
      const response = await exportLatFiles(filters);
      await downloadExportResponse(response, "lat_files_export");
    ...
    <div className="flex flex-col h-screen bg-card">
      ...
      <nav className="bg-card border-b px-6 py-4 text-sm text-muted-foreground">
        <div className="flex items-center gap-2">
          ...
          <ChevronRight className="w-4 h-4" />
          <span className="text-foreground font-medium">LAT Files</span>
        </div>
      </nav>
