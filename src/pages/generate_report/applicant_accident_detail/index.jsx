...
import { exportApplicantAccidentDetail } from "./helper/exportApplicantAccidentDetail";
import ContactSearch from "@/pages/calender/components/ContactSearch";

const ExportApplicantAccidentDetail = () => {
    ...
    try {
      ...
      switch (formData.type) {
        case "select_applicant":
          filters.select_applicant = formData.select_applicant;
          break;
        case "year_wise":
      ...
      const response = await exportApplicantAccidentDetail(filters);
      const csvData = response?.response || response || "";

      exportToExcel(csvData, "applicant_accident_detail_export");
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent side="bottom" avoidCollisions={false}>
                      ...
                      <SelectItem value="select_applicant">
                        Select Applicant
                      </SelectItem>
                ...
                {/* Select Applicant - ContactSearch */}
                {formData.type === "select_applicant" && (
                  <ContactSearch
                    label="Select Applicant"
                    onSelect={(contact) => {
                      setFormData((prev) => ({
                        ...prev,
                        select_applicant: contact.slug || "",
                      }));
                    }}
                  />
                )}
...
export default ExportApplicantAccidentDetail;
