...
const VsrInsExam = () => {
  ...
  const onAdd = () => {
    navigate(`/dashboard/vsr-insurance-examination/add/${slug}`);
  };
  ...
  const breadcrumbs = [{ title: "VSR", isNavigation: false }];
  ...
  return (
    <div className="flex flex-col w-full lg:w-[82.5vw]">
      ...
      <div className="px-4">
        <CustomActionMenu
          title="VSR Insurance Examnation"
          total={blogsLength}
          onAdd={onAdd}
