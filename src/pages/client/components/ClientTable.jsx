...
import { fetchClientList } from "../helpers/fetchClientList";
...
const ClientTable = ({ slug, setBlogsLength, params = {} }) => {
  ...
  const {
    ...
    queryKey: ["clientlist", slug, params.search],
    queryFn: () => fetchClientList(slug, { search: params.search || "" }),
    enabled: !!slug,
  });
  ...
  const onNavigateToEdit = (section) => {
    ...
    navigate(`/dashboard/client/edit/${section.id}`);
  };
