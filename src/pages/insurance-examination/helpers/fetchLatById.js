...
export const fetchInsExamById = async (id) => {
  try {
    console.log("🔍 Fetching section with ID:", id);
    console.log("📍 API Endpoint:", `${endpoints.insuranceExamination}/${id}`);

    const apiResponse = await apiService({
      endpoint: `${endpoints.insuranceExamination}/${id}`,
    });
    ...
    // Check if response is empty string or null
